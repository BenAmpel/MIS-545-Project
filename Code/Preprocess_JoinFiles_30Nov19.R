...
## Versions:
# 30November2019 - updated to include 'driverId' and 'constructorId' in output
...
# arrange columns
resultsHistorical <- resultsHistorical[, c("result_finishOrder", "result_inThePoints", "result_startingGridPosition", "driverId", 
                                           "driver_name", "constructorId", "constructor_name", "circuit_name", "circuit_city", "race_month",
